...
public class IncorrectPasswordException extends Exception{
     ...
     */
    public IncorrectPasswordException(int UserID, byte[] onceHashedPasswordString){
        super(String.format("The given password does not match.\nUser: %s, HashedPassword: %s", Integer.toString(UserID), new String(onceHashedPasswordString)));
    }
